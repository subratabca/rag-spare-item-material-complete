          ...
          <div class="row">
            ...
            <div class="col-md-12 p-4">
              <div class="form-check">
                ...
                <label class="form-check-label" for="defaultCheck3"><a href="/client/terms-conditions/food_upload" target="_blank">Accept T&C For Item Upload</a><span class="text-danger">*</span></label>
              </div>
